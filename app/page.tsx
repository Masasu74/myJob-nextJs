...
export default function Home() {
  return (
    <></>
    // <div className="px-36 py-20 bg-gray-100  gap-16 flex flex-col">

    //   <div className="flex justify-between gap-16">
    //     <div className="flex flex-col gap-7 w-1/2">
    //       <p className="text-[4em] font-medium">Find a job that suits your interest & skills.</p>
    ...
    //       <div className="bg-white py-3 px-2 flex items-center justify-center rounded-sm gap-2">
